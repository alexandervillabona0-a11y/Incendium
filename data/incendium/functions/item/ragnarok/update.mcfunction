...
execute if entity @s[scores={in.ragnarok=40}] run playsound minecraft:entity.evoker.prepare_summon master @a[distance=..16] ~ ~ ~ 1 2
execute if entity @s[scores={in.ragnarok=40}] run playsound minecraft:item.trident.return master @s ~ ~ ~ 1 2
execute if entity @s[scores={in.ragnarok=40}] run playsound minecraft:item.trident.return master @s ~ ~ ~ 1 2
